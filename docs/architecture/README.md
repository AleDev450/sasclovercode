...
| `database.md`                | Schema conventions, indexes, constraints | Phase 01           |
| `multitenancy.md`            | Tenant resolution, isolation, RLS model  | Phase 01           |
| `authentication.md`          | Supabase Auth, SSR sessions, cookies     | Phase 02           |
