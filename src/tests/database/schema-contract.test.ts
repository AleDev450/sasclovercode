...
const EXPECTED_COLUMNS: Record<string, Record<string, ColumnSpec>> = {
  orders: {
    ...
    promotion_discount_cents: { dataType: "bigint", nullable: false },
  ...
  promotions: {
    ...
    type: { dataType: "USER-DEFINED", nullable: false },
    percent_off: { dataType: "smallint", nullable: true },
    amount_off_cents: { dataType: "bigint", nullable: true },
    min_order_cents: { dataType: "bigint", nullable: false },
    starts_at: { dataType: "timestamp with time zone", nullable: true },
    ends_at: { dataType: "timestamp with time zone", nullable: true },
    max_redemptions: { dataType: "integer", nullable: true },
    times_redeemed: { dataType: "integer", nullable: false },
    is_active: { dataType: "boolean", nullable: false },
    created_at: { dataType: "timestamp with time zone", nullable: false },
    updated_at: { dataType: "timestamp with time zone", nullable: false },
  },
  coupons: {
    id: { dataType: "uuid", nullable: false },
    tenant_id: { dataType: "uuid", nullable: false },
    promotion_id: { dataType: "uuid", nullable: false },
    code: { dataType: "text", nullable: false },
    max_redemptions: { dataType: "integer", nullable: true },
    times_redeemed: { dataType: "integer", nullable: false },
    expires_at: { dataType: "timestamp with time zone", nullable: true },
    is_active: { dataType: "boolean", nullable: false },
    created_at: { dataType: "timestamp with time zone", nullable: false },
    updated_at: { dataType: "timestamp with time zone", nullable: false },
  },
  order_promotions: {
    ...
    tenant_id: { dataType: "uuid", nullable: false },
    order_id: { dataType: "uuid", nullable: false },
    promotion_id: { dataType: "uuid", nullable: true },
    coupon_id: { dataType: "uuid", nullable: true },
    loyalty_transaction_id: { dataType: "uuid", nullable: true },
    source: { dataType: "text", nullable: false },
    label_snapshot: { dataType: "text", nullable: false },
    discount_cents: { dataType: "bigint", nullable: false },
    created_by: { dataType: "uuid", nullable: true },
    created_at: { dataType: "timestamp with time zone", nullable: false },
  },
  loyalty_accounts: {
    ...
    tenant_id: { dataType: "uuid", nullable: false },
    customer_id: { dataType: "uuid", nullable: false },
    points_balance: { dataType: "integer", nullable: false },
    enrolled_at: { dataType: "timestamp with time zone", nullable: false },
    created_at: { dataType: "timestamp with time zone", nullable: false },
    updated_at: { dataType: "timestamp with time zone", nullable: false },
  },
  loyalty_transactions: {
    id: { dataType: "uuid", nullable: false },
    tenant_id: { dataType: "uuid", nullable: false },
    account_id: { dataType: "uuid", nullable: false },
    type: { dataType: "USER-DEFINED", nullable: false },
    points: { dataType: "integer", nullable: false },
  ...
  subscriptions: {
    id: { dataType: "uuid", nullable: false },
    tenant_id: { dataType: "uuid", nullable: false },
    plan_code: { dataType: "text", nullable: false },
    status: { dataType: "USER-DEFINED", nullable: false },
    trial_ends_at: { dataType: "timestamp with time zone", nullable: true },
    current_period_start: { dataType: "timestamp with time zone", nullable: false },
    current_period_end: { dataType: "timestamp with time zone", nullable: true },
    cancelled_at: { dataType: "timestamp with time zone", nullable: true },
    cancel_at_period_end: { dataType: "boolean", nullable: false },
    created_at: { dataType: "timestamp with time zone", nullable: false },
    updated_at: { dataType: "timestamp with time zone", nullable: false },
  },
  tenant_modules: {
    tenant_id: { dataType: "uuid", nullable: false },
    module_code: { dataType: "text", nullable: false },
  ...
  saas_payments: {
    id: { dataType: "uuid", nullable: false },
    tenant_id: { dataType: "uuid", nullable: false },
    subscription_id: { dataType: "uuid", nullable: false },
    plan_code_snapshot: { dataType: "text", nullable: false },
    period_start: { dataType: "timestamp with time zone", nullable: false },
    period_end: { dataType: "timestamp with time zone", nullable: false },
    amount_cents: { dataType: "bigint", nullable: false },
    currency: { dataType: "text", nullable: false },
    status: { dataType: "USER-DEFINED", nullable: false },
    due_at: { dataType: "timestamp with time zone", nullable: false },
    paid_at: { dataType: "timestamp with time zone", nullable: true },
    method: { dataType: "text", nullable: true },
    reference: { dataType: "text", nullable: true },
    notes: { dataType: "text", nullable: true },
    created_by: { dataType: "uuid", nullable: true },
    created_at: { dataType: "timestamp with time zone", nullable: false },
  ...
  subscription_events: {
    ...
    type: { dataType: "USER-DEFINED", nullable: false },
    from_status: { dataType: "USER-DEFINED", nullable: true },
    to_status: { dataType: "USER-DEFINED", nullable: true },
    from_plan: { dataType: "text", nullable: true },
    to_plan: { dataType: "text", nullable: true },
    saas_payment_id: { dataType: "uuid", nullable: true },
    detail: { dataType: "text", nullable: true },
    actor_id: { dataType: "uuid", nullable: true },
    created_at: { dataType: "timestamp with time zone", nullable: false },
  },
  audit_logs: {
    id: { dataType: "uuid", nullable: false },
    tenant_id: { dataType: "uuid", nullable: false },
    user_id: { dataType: "uuid", nullable: true },
    user_email: { dataType: "text", nullable: true },
    action: { dataType: "text", nullable: false },
    entity_type: { dataType: "text", nullable: false },
    entity_id: { dataType: "uuid", nullable: true },
    old_values: { dataType: "jsonb", nullable: true },
    new_values: { dataType: "jsonb", nullable: true },
    ip_address: { dataType: "inet", nullable: true },
    user_agent: { dataType: "text", nullable: true },
    request_id: { dataType: "text", nullable: true },
    created_at: { dataType: "timestamp with time zone", nullable: false },
  },
  rate_limit_counters: {
    bucket: { dataType: "text", nullable: false },
    subject_hash: { dataType: "text", nullable: false },
    window_start: { dataType: "timestamp with time zone", nullable: false },
    hits: { dataType: "integer", nullable: false },
  },
  tenants: {
    id: { dataType: "uuid", nullable: false },
    name: { dataType: "text", nullable: false },
