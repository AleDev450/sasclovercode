...
describe("migrations (TEST-117, TEST-118)", () => {
  it("apply cleanly and in lexicographic order", async () => {
    ...
    expect(files).toEqual([
      ...
      "20260828120600_create_delivery_roster.sql",
      ...
      // Phase 29
      "20260916120000_extend_section_types_storefront.sql",
      "20260916120100_create_storefront.sql",
      "20260916120200_extend_order_items_options.sql",
      "20260916120300_create_web_orders.sql",
      // Phase 30
      "20260917120000_create_legal_and_complaints.sql",
      // Phase 31
